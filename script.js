...
let username = prompt("Enter your damn name")
...
let class1={className:"star class" , teacher:"pham" , grade:"100"}


// Task 5: Console log "I'm taking [className] with [teacher]"

console.log(" Im taking " + class1["className"] + " with " + class1["teacher"] )
